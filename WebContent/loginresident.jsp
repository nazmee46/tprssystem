...
<head>
	...
	<title>Resident | Resident Login</title>
...
<body>
	<main class="form-signin text-center mt-8 bg-accent">
		<input type="button" class="w-50 p-3 fw-bold bg-accent" value="Resident"> 
		<form action="Login_ServletResident" method="post" class="m-4">
			...
			<div class="form-floating">
				<input type="text" name="resid" class="form-control" placeholder="ID number" required>
				<label>Enter your ID</label>
			</div>
			<div class="form-floating">
				<input type="password" name="respass" class="form-control" placeholder="Password" required>
