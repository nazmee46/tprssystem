...
<body>
	<div class="sidebar p-3 bg-accent">
		...
		<div class="staff-level px-4 fs-6 text-secondary mb-2">
			<c:out value="${session_idnum}"></c:out>
		</div>
		<hr>
		<ul class="mt-4 nav nav-pills flex-column mb-auto">
			...
			<li>
				<a href="Redirect_Servlet?action=resident" class="nav-link active">
					<img src="assets/icons/user_white.svg" class="pb-1 px-2">
					<label class="link-name">Resident</label>
				</a>
			</li>
			<li>
	...
	<div class="content p-3">
		...
		<div class="py-3 fs-3 fw-bold">Resident</div>
				...
				<table id="example" class="display" style="width: 100%">
					...
					<tbody>
						<c:forEach items="${committeelist}" var="committee">
							<tr>
								<td><c:out value="${committee.commid}"></c:out></td>
								...
								<td>
									<button
										onclick="window.location.href='Redirect_Servlet?action=supplier_update&id=<c:out value="${suplist.supplier_idnum}"></c:out>'"
										class="btn btn-sm m-1 btn-secondary" style="border: none;">
										<img src="assets/icons/edit_white.svg" class="py-1">
									</button>
									<button
										onclick="window.location.href='Redirect_Servlet?action=supplier_delete&id=<c:out value="${suplist.supplier_idnum}"></c:out>'"
										class="btn btn-sm m-1 btn-danger" style="border: none;">
										<img src="assets/icons/delete_white.svg" class="py-1">
									</button>
								</td>
							</tr>
						</c:forEach>
